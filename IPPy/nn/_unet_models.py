...
# UNet
def UNet(input_shape, n_scales, conv_per_scale, init_conv=64, final_relu=False, skip_connection=True):
    """
...
# UNet 3D
def UNet3d(input_shape, n_scales, conv_per_scale, init_conv=64, final_relu=False, skip_connection=True):
    """
