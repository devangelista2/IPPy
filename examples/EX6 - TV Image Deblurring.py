...
from IPPy.utilities import load_image, save_image
...
# Save the results
save_image(x_true, "gt_image.png")
save_image(y_delta, "blurred_image.png")
save_image(x_sol, "deblurred_image.png")
